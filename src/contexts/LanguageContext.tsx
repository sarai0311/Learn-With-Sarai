...
const translations: Record<'en' | 'es', Record<string, string>> = {
  en: {
    ...
    'hero.cardTitle': "Hi! I'm Sarai",
    'hero.cardSubtitle': "Certified Spanish Teacher from Colombia",
  ...
  es: {
    ...
    'hero.cardTitle': '¡Hola! Soy Sarai',
    'hero.cardSubtitle': 'Profesora certificada de español de Colombia',
