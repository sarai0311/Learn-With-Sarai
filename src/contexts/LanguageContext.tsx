...
const translations: Record<'en' | 'es', Record<string, string>> = {
  en: {
    ...
    'services.trial.title': 'Trial Class',
    ...
    'services.premium.price': '€31.50',
    'services.premium.feature1': '75-minute sessions',
    ...
    'services.packages.subtitle': 'Save money with discounted class packages while committing to consistent learning',
    ...
    'services.faq.a2': "Nope! All learning materials are included in your class fee. I create custom materials based on what you need and your learning style.",
  ...
  es: {
    ...
    'services.premium.price': '€31.50',
    'services.premium.feature1': 'Sesiones de 75 minutos',
    ...
    'services.packages.subtitle': 'Ahorra dinero con paquetes de clases con descuento mientras te comprometes al aprendizaje consistente',
    ...
    'services.faq.q1': '¿Qué tecnología necesito para las clases online?',
    'services.faq.a1': 'Solo necesitas una computadora o tablet con una conexión estable a internet, una cámara web y un micrófono. Usaremos una plataforma de aula virtual simple que es fácil de acceder.',
    'services.faq.q2': '¿Necesito comprar algún libro de texto?',
    'services.faq.a2': '¡No! Todos los materiales de aprendizaje están incluidos en la tarifa de tu clase. Creo materiales personalizados basados en lo que necesitas y tu estilo de aprendizaje.',
